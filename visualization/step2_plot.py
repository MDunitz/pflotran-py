...
def make_3d_scatter_trace(data, variable, var_min=None, var_max=None, colorbar_x=1.02, colorbar_y=0.5, name=None):
    if var_min is None:
    ...
    for time_idx in time_indices:
        ...
        for i, var in enumerate(available_vars):
            ...
            scatter = make_3d_scatter_trace(
                time_data, var, var_min, var_max, colorbar_x=colorbar_x, colorbar_y=colorbar_y, name=f"{var} (t={time_idx})"
            )
    ...
    for i, var in enumerate(available_vars):
        ...
        fig.add_trace(
            make_3d_scatter_trace(
                initial_data, var, var_min, var_max, colorbar_x=colorbar_x, colorbar_y=colorbar_y, name=var
            ),
            row=row, col=col
        )
